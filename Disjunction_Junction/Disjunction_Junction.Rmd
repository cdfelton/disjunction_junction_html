...
```{r}
graph3_data = left_join(means, mean_part2, by = "ID")
graph3_data = left_join(graph3_data, key2, by = 'ID')
g3 = ggplot(aes(Mean_Chance, Implicature_Rate), data = graph3_data) +
...
model_3 = lm(chance ~ ID * experiment, data = model3_data)
summary(model_3)
