...
let practiceTests = [
  { A: "Mike hates all types of fruit or Mike's favorite food is watermelon.", B:"How likely is it that Mike hates all types of fruit and Mike's favorite food is watermelon?", Explanation: "Since it's impossible to hate all fruit and have watermelon be your favorite food, the correct answer here is all the way at the left end of the slider."},
  { A: "My favorite color is a primary color or is yellow, red, or blue.", B:"How likely is it that the speaker's favorite color is a primary color or is yellow, red, or blue?" , Explanation: "Since yellow red and blue are the only primary colors, the correct answer here is all the way at the right end of the slider, since these things must both be true if one is true."},
...
let GIST_LINK = 'https://gist.githubusercontent.com/cdfelton/2d813e89cddc55f735872dad6ba62e84/raw/169995e9676373b38e257543ee9abba6a10dcf96/stimuli_2.json';
let stimuli;
userResult = [];
